...
class verify(object):
    ...
    def valid_proof():
        ...
        block = f'{nonce}{timestamp}{previous_hash}{data}'.encode()
        block_hash = hashlib.sha256(block).hexdigest()

        # Debug
        if block_hash[:4] == "7007":
            print("Block is valid! ( blockhash: " + block_hash + " | nonce: " + str(nonce) + " | time: " + str(timestamp) + " | last_hash: " + last_hash + " | data: " + str(data))
        else:
            print("Block is invalid! ( blockhash: " + block_hash + " | nonce: " + str(nonce) + " | time: " + str(timestamp) + " | last_hash: " + last_hash + " | data: " + str(data))
